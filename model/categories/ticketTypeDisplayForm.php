...
$sql = "SELECT `type`, `typeID` FROM `ticketTypes`";
                ...
                <?php foreach ($types as $type) : ?>
                    <tr>
                        ...
                        <td> <form action="deletecategory.php" method="post" >
                            <input name="deleteTicketType" type="hidden" value="<?php echo $type['typeID']?>">
                            <input name="action" type ="hidden" value="deleteTicketType">
                            <input name="path" type ="hidden" value="ticketTypeDisplayForm.php">
                ...
                <?php endforeach; ?>
                    ...
                    <tr> <form action="addcategory.php" method="post" >
                        ...
                        <td> <input type="submit" name="Add" value="    Add   "> 
                            <input type="hidden" name="action" value="addTicketType"></td>
                    </form>
                    </tr>
                </table>
